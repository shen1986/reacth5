...
const mapStateToProps = ({ goods, loading }: GlobalState) => {
    return {
        goods: goods.goods,
        loading: loading.effects["seller/asyncGetGoods"]
    };
};
...
const Goods: FC<PageProps> = (props) => {
    const {
        dispatch,
        goods,
    } = props
                            ...
                            return (
                                ...
                                >
                                    <span className="text border-1px">
                                        {item?.type as number > 0 && <span className={spanClass} />}
                                        { item.name }
                                    </span>
                                </li>
                            )
